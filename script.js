...
const STORY_DATA = {
  debate: {
    ...
    body: `<p>2025년 대선을 앞두고 녹색전환연구소와 시민·연대 단체는 기후위기 대응을 공식 토론 의제로 올릴 것을 캠페인했습니다. <strong>온라인 청원 1,600명</strong>, <strong>오프라인 서명 800명 이상</strong>이 모였고, 재난 대응 후보 2차 TV토론회에서 기후위기가 단일 의제로 채택됐습니다.</p>
<p>시민이 적어주신 <strong>784개</strong>의 기후 관련 질문을 정리해 후보자에게 전달했습니다. 한국 선거 역사상 처음으로 기후위기 대응이 대선 공식 토론 의제가 됐습니다.</p>`,
  },
  governance: {
...
<p>2025년 대선 전 공동 기후공약 30개 중 상당수가 현 정부 123개 국정과제에 반영되었고, 기후시민회의 신설(국정과제 40) 등이 포함되었습니다. 연구소가 그린 개편안은 법적·제도적 근거 마련까지 이어졌습니다.</p>
<ul>
<li>기후에너지환경부 출범</li>
<li>국립기후과학원 설립 추진</li>
...
<p>10곳 중 4곳은 전면 재설계가 필요한 수준이라는 결론을 냈고, 그 결과는 한국환경공단 탄소중립 기본계획 가이드라인 개정안에 반영되고 있습니다. 민간 독립 싱크탱크이기 때문에 가능한 일이었습니다.</p>`,
  ...
  esg: {
    ...
    body: `<p>2024년부터 연구소는 금융위 ESG 공시 로드맵이 기후 책임을 충분히 담지 못한다는 점을 지적하며 공론장을 열었습니다. 투자·회계 전문가의 영역이던 ESG를 <strong>기후·에너지 정의</strong>의 문제로 끌어올렸습니다.</p>
<p>2025년 탄소중립·녹색성장 기본법 개정과 중소기업 녹색전환 지원 등 국정과제에도 연구소 제안이 반영되었습니다. 기업 공시가 시민의 삶과 연결되는 제도로 바뀌도록 압력을 이어가고 있습니다.</p>`,
  },
};
...
(() => {
  ...
  const title = document.title || "녹색전환연구소 · 첫 번째 후원 캠페인 · 프로젝트 2030";
